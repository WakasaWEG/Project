...
<head>
  ...
  <title>Онлайн-аптека | Рецептурные препараты</title>
  <style>
    body {
...
<body>
  ...
  <main class="main-content">
    ...
    <div class="catalog-switcher">
      <a href="Catalog.php">Без рецепта</a>
      <a href="Catalog1.php" class="active">Рецептурные препараты</a>
    </div>
    ...
    <div class="products-grid">
      <?php
        ...
        $result = $conn->query("SELECT * FROM medication WHERE Description = 'По рецепту'");
        while ($row = $result->fetch_assoc()) {
            ...
            <div class='product-card'>
                ...
                <div class='product-info'>
                    ...
                    <span class='product-status'>По рецепту</span>
                </div>
